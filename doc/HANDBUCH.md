...
Auf Basis dieses Handbuchs können wir:

- ein **Quick‑Start‑Poster** erstellen (kompakte 1‑Seiten‑Übersicht)  
- eine **Online‑Hilfe** strukturieren (z. B. als HTML oder Markdown‑Dokumentation)  

Wenn du möchtest, können wir im nächsten Schritt:

- die Screenshots konkret benennen (Dateinamen, Auflösung)  
- ein Layout für das Quick‑Start‑Poster definieren  
- eine Gliederung für die Online‑Hilfe festlegen.
```
